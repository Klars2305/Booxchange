...
<head>
  ...
  <!-- Favicons -->
  <link href= "{{asset('/css/book.png')}}" rel="icon">
        ...
        <div class="row gy-5">
          <div class="col-lg-6 order-2 order-lg-1 d-flex flex-column justify-content-center">
            ...
            <div class="d-flex">
              ...
              <a href="{{url('/images/https://www.youtube.com/watch?v=UMogVGvhs7U')}}" class="glightbox btn-watch-video d-flex align-items-center"><i class="bi bi-play-circle"></i><span>Watch Video</span></a>
            </div>
          </div>
